...
* [g3d](https://github.com/groverburger/g3d) ⭐ 827 | 🐛 3 | 🌐 Lua | 📅 2026-05-03 - Simple and easy 3D engine for LÖVE.
* [3DreamEngine](https://github.com/3dreamengine/3DreamEngine) ⭐ 497 | 🐛 14 | 🌐 Lua | 📅 2023-05-25 - An awesome 3D engine for LÖVE.
* [Menori](https://github.com/rozenmad/Menori) ⭐ 293 | 🐛 6 | 🌐 Lua | 📅 2025-08-26 - Library for 3D rendering with LÖVE.
...
* [anim9](https://github.com/excessive/anim9) ⭐ 32 | 🐛 0 | 🌐 Lua | 📅 2020-05-07 - 3D skeletal animation library (design to be used with IQM and IQE).
...
* [LÖVElyTrees](https://github.com/Nrosa01/LOVElyTrees) ⭐ 20 | 🐛 0 | 🌐 Lua | 📅 2025-02-17 - Fully featured behaviour tree implementation with tree rendering.
* [astar](https://github.com/xiejiangzhi/astar) ⭐ 17 | 🐛 1 | 🌐 Lua | 📅 2025-06-06 - An other A\* library. Any map (grid, point, mesh or infinite map) and support path cost.
* [FluadHTN](https://github.com/Safebox36/OdaiHTN) ⭐ 12 | 🐛 1 | 🌐 Lua | 📅 2026-06-18 - A powerful hierarchical task network for AI planning.
...
* [anim8](https://github.com/kikito/anim8) ⭐ 984 | 🐛 7 | 🌐 Lua | 📅 2022-01-20 - Animation library.
* [SYSL-Text](https://github.com/sysl-dev/SYSL-Text) ⭐ 118 | 🐛 0 | 🌐 Lua | 📅 2024-08-03 - Text animation and automatic wrapping library based on tags.
* [Peachy](https://github.com/josh-perry/peachy) ⭐ 113 | 🐛 0 | 🌐 Lua | 📅 2026-05-04 - A parser/renderer for Aseprite animations in LÖVE.
...
* [chiro](https://github.com/bjornbytes/chiro) ⭐ 28 | 🐛 0 | 🌐 Lua | 📅 2018-03-18 - Convenience wrapper around [Spine](http://esotericsoftware.com).
* [skeletor](https://github.com/pelevesque/skeletor) ⭐ 25 | 🐛 1 | 🌐 Lua | 📅 2019-05-10 - 2D skeletal animation system.
* [Lump](https://github.com/sixFingers/lump) ⭐ 19 | 🐛 0 | 🌐 Lua | 📅 2016-07-05 - Adobe Flash animation runtime.

## Camera

*Viewport & Camera Libraries*

* [gamera](https://github.com/kikito/gamera) ⭐ 301 | 🐛 0 | 🌐 Lua | 📅 2021-07-29 - Camera system.
...
* [roomshift](https://github.com/mshiplet/roomshift) ⭐ 2 | 🐛 0 | 🌐 Lua | 📅 2026-01-18 - Room-based camera with smooth transitions.
...
* [lurker](https://github.com/rxi/lurker) ⭐ 377 | 🐛 6 | 🌐 Lua | 📅 2023-07-22 - Auto-swaps changed Lua files in a running game.
* [LÖVE API](https://github.com/love2d-community/love-api) ⭐ 375 | 🐛 13 | 🌐 Lua | 📅 2026-05-07 - The complete API documentation of LÖVE in a Lua table.
...
* [LÖVE Build](https://github.com/nhartland/love-build) ⭐ 76 | 🐛 2 | 🌐 Shell | 📅 2026-06-25 - GitHub Action for automated cross-platform builds.
...
* [loveprofiler](https://github.com/dknight/loveprofiler) ⭐ 13 | 🐛 0 | 🌐 Lua | 📅 2024-08-15 - An extremely simple logger and profiler.

## Drawing

*Drawing specific Libraries, that simplify the Drawing process*

* [Push](https://github.com/Ulydev/push) ⭐ 665 | 🐛 16 | 🌐 Lua | 📅 2023-09-25 - A simple resolution-handling library for LÖVE.
...
* [Shöve](https://github.com/Oval-Tutu/shove) ⭐ 97 | 🐛 3 | 🌐 Lua | 📅 2025-05-23 - A powerful resolution-handler and rendering library for LÖVE.
...
* [tiny-ecs](https://github.com/bakpakin/tiny-ecs) ⭐ 783 | 🐛 0 | 🌐 Lua | 📅 2023-03-15 - Entity Component System for Lua that's simple, flexible, and useful.
...
* [evolved.lua](https://github.com/BlackMATov/evolved.lua) ⭐ 218 | 🐛 1 | 🌐 Lua | 📅 2026-04-08 - Evolved ECS (Entity-Component-System) for Lua.
...
* [lume](https://github.com/rxi/lume/) ⭐ 1,237 | 🐛 22 | 🌐 Lua | 📅 2023-11-19 - Collection of functions for Lua, geared towards game development.
* [Simple Tiled Implementation](https://github.com/karai17/Simple-Tiled-Implementation) ⭐ 1,074 | 🐛 32 | 🌐 Lua | 📅 2024-03-24 - Tiled map loader and renderer.
* [knife](https://github.com/airstruck/knife) ⭐ 519 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Collection of useful micro-modules for Lua (Class, State Machines, Bind, Chain, Coroutines, Event, Memoize, Entity, Tests, Timer).
* [batteries](https://github.com/1bardesign/batteries/) ⭐ 434 | 🐛 3 | 🌐 Lua | 📅 2026-05-26 - Fills out lua's sparse standard library and provides implementations of common algorithms and data structures useful for games.
* [lua-state-machine](https://github.com/kyleconroy/lua-state-machine) ⭐ 401 | 🐛 6 | 🌐 Lua | 📅 2025-06-25 - Lua Finite State Machine.
* [rotLove](https://github.com/paulofmandown/rotLove) ⭐ 290 | 🐛 11 | 🌐 Lua | 📅 2022-04-03 - Roguelike Toolkit in LÖVE. A LÖVE/lua port of rot.js.
* [astray](https://github.com/SiENcE/astray) ⭐ 179 | 🐛 0 | 🌐 Lua | 📅 2026-06-22 - A Lua-based maze, room and dungeon generation library for dungeon crawlers and roguelike video games.
...
* [prism](https://github.com/PrismRL/prism) ⭐ 120 | 🐛 51 | 🌐 Lua | 📅 2026-07-20 - A comprehensive traditional roguelike engine.
* [hump](https://github.com/HDictus/hump) ⭐ 100 | 🐛 5 | 🌐 Lua | 📅 2023-02-22 - Collection of tools for developing games with LÖVE (Gamestates, Timers/Tweens, Vectors, Classes, Signals, Cameras).
* [Love dialogue](https://github.com/Miisan-png/Love-Dialogue) ⭐ 84 | 🐛 3 | 🌐 Lua | 📅 2026-07-28 - Simple to use Dialogue Library for Love2d with custom scripting language for dialogues .
* [cartographer](https://github.com/tesselode/cartographer) ⭐ 78 | 🐛 3 | 🌐 Lua | 📅 2020-11-28 - Small Tiled map loader and drawer.
...
* [Manami](https://github.com/MikuAuahDark/NPad93/blob/master/manami.lua) ⭐ 66 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - An improved "reflowprint" with UTF-8, multicolor, and justify support.
...
* [GameStateManager](https://github.com/GwyrddGlas/GameStateManager) ⭐ 20 | 🐛 1 | 🌐 Lua | 📅 2025-12-28 - A lightweight, optimized, and easy-to-implement solution for efficient game state management.
...
* [SceneMan](https://github.com/KINGTUT10101/SceneMan) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2025-11-02 - A simple, but powerful scene/gamestate manager that uses a stack, allowing you to run multiple scenes at once.
...
* [Kazari](https://github.com/MikuAuahDark/Kazari) ⭐ 14 | 🐛 0 | 🌐 Lua | 📅 2022-12-13 - Multitouch gesture and input library.
...
* [input](https://github.com/xiejiangzhi/input) ⭐ 7 | 🐛 0 | 🌐 Lua | 📅 2021-01-04 -  Simple and powerful input library. support check operation time, sequence.
...
* [Light World](https://github.com/tanema/light_world.lua) ⭐ 243 | 🐛 11 | 🌐 Lua | 📅 2025-11-04 - A lighting model.
* [Shädows](https://github.com/matiasah/shadows) ⭐ 183 | 🐛 2 | 🌐 Lua | 📅 2020-07-08 - A Shadows & Lights engine for LÖVE.
* [lighter](https://github.com/speakk/lighter) ⭐ 44 | 🐛 1 | 🌐 Lua | 📅 2026-02-08 - A performant dynamic light implementation with a simple API.
* [Simple Love Lights](https://github.com/dylhunn/simple-love-lights) ⭐ 30 | 🐛 0 | 🌐 Lua | 📅 2020-03-24 - A very simple raycasting light implementation.
* [Light](https://github.com/xiejiangzhi/light) ⭐ 17 | 🐛 0 | 🌐 Lua | 📅 2019-09-17 - A simple dynamic light implementation.
* [bitumbra](https://github.com/a13X-B/bitumbra) ⭐ 10 | 🐛 0 | 🌐 Lua | 📅 2026-05-02 - GPU accelerated many lights 2D shadows.

## Math

*Math specific Libraries*

* [Cirno's Perfect Math Library](https://github.com/excessive/cpml) ⭐ 350 | 🐛 17 | 🌐 Lua | 📅 2026-02-11 - Math/intersection library designed for games.
...
* [polysec](https://github.com/dknight/polysec) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2025-04-13 - A performant and lightweight library to detect polygon and rectangle intersections.
...
* [Lua-Opus](https://github.com/GwyrddGlas/Lua-Opus) ⭐ 5 | 🐛 0 | 🌐 Lua | 📅 2026-01-29 - A module for streaming and decoding Ogg Opus audio files with queueable playback and PCM integration.
...
* [Sock.lua](https://github.com/camchenry/sock.lua) ⭐ 182 | 🐛 7 | 🌐 Lua | 📅 2020-12-31 - A Lua networking library for LÖVE games. (IPv4)
...
* [love2d-lua-websocket](https://github.com/flaribbit/love2d-lua-websocket) ⭐ 52 | 🐛 2 | 🌐 Lua | 📅 2021-11-02 - A simple event-driven WebSocket client library. (IPv4)
* [löve-ws](https://github.com/holywyvern/love-ws) ⭐ 30 | 🐛 2 | 🌐 C++ | 📅 2018-10-27 - A WebSocket client and server library.
* [fetch-lua](https://github.com/elloramir/fetch-lua) ⭐ 12 | 🐛 0 | 🌐 Lua | 📅 2025-06-19 - An HTTPS/HTTP requests library made only with luajjit.

## OO

*Object Orientation Libraries that support [Class-Commons](https://github.com/bartbes/Class-Commons) ⭐ 58 | 🐛 2 | 📅 2018-01-13*

* [middleclass](https://github.com/kikito/middleclass) ⭐ 1,917 | 🐛 1 | 🌐 Lua | 📅 2025-11-03 - Simple OOP library for Lua; has inheritance, metamethods (operators), class variables and weak mixin support (class-commons).
* [classic](https://github.com/rxi/classic/) ⭐ 1,071 | 🐛 19 | 🌐 Lua | 📅 2021-12-31 - Tiny class module for Lua. Attempts to stay simple and provide decent performance by avoiding unnecessary over-abstraction.
* [knife.base](https://github.com/airstruck/knife/blob/master/readme/base.md) ⭐ 519 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Extremely minimal base class providing single inheritance and constructors.
...
* [jprof](https://github.com/pfirsich/jprof) ⭐ 104 | 🐛 9 | 🌐 Lua | 📅 2026-08-06 - Profiling library/tool for LÖVE.
* [AppleCake](https://github.com/EngineerSmith/AppleCake) ⭐ 31 | 🐛 1 | 🌐 Lua | 📅 2026-05-07 - Profiling library for LÖVE, with detailed profiling and thread support.
...
* [Bump](https://github.com/kikito/bump.lua) ⭐ 1,097 | 🐛 13 | 🌐 Lua | 📅 2023-09-29 - Collision detection library for Lua.
...
* [slick](https://github.com/erinmaus/slick/) ⭐ 81 | 🐛 7 | 🌐 Lua | 📅 2026-04-08 - A simple to use polygon collision library inspired by bump.lua.
...
* [loveblobs](https://github.com/zhangf911/loveblobs) ⭐ 2 | 🐛 0 | 📅 2018-10-21 - A softbody library with support for both dynamic and static arbitrary softbodies.
...
* [LÖVR](https://github.com/bjornbytes/lovr) ⭐ 2,582 | 🐛 25 | 🌐 C | 📅 2026-08-11 - LÖVE for virtual reality devices.
* [LoveDos](https://github.com/rxi/lovedos) ⚠️ Archived - A Lua framework for 2D DOS games, implementing a subset of the LÖVE API.
* [LÖVE Potion](https://github.com/lovebrew/lovepotion) ⭐ 699 | 🐛 8 | 🌐 C++ | 📅 2026-08-04 - Unofficial implementation of the LÖVE for Nintendo (3DS, Switch and Wii U) Homebrew.
...
* [knife.serialize](https://github.com/airstruck/knife/blob/master/readme/serialize.md) ⭐ 519 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Serialize data as a Lua script.
* [binser](https://github.com/bakpakin/binser) ⭐ 215 | 🐛 3 | 🌐 Lua | 📅 2023-03-02 - Customizable Lua Serializer.
* [bitser](https://github.com/gvx/bitser) ⭐ 181 | 🐛 5 | 🌐 Lua | 📅 2025-01-31 - Serializes and deserializes Lua values with LuaJIT.
* [Ser](https://github.com/gvx/Ser) ⭐ 85 | 🐛 0 | 🌐 Lua | 📅 2016-05-19 - Fast, robust, richly-featured table serialization library for Lua.
* [Lady](https://github.com/gvx/Lady) ⭐ 38 | 🐛 0 | 🌐 Lua | 📅 2016-02-16 - Saving and loading savegames; based on Ser.
...
* [Moonshine](https://github.com/vrld/moonshine) ⭐ 725 | 🐛 18 | 🌐 Lua | 📅 2023-12-23 - Repository of common post-processing effects like blur, vignette, color-grading, etc.
* [LoveShaderConverter](https://github.com/tsteinholz/LoveShaderConverter) ⭐ 97 | 🐛 2 | 🌐 C++ | 📅 2016-06-25 - Convert Shadertoy Shader files to LÖVE GLSL Files with handy utilities for infinite purposes.
* [ngrading](https://github.com/MikuAuahDark/NPad93/tree/master/ngrading) ⭐ 66 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Simple color grading library.
...
* [busted](https://github.com/lunarmodules/busted) ⭐ 1,627 | 🐛 66 | 🌐 Lua | 📅 2026-07-30 - Simple unit-testing framework with customizable assertions.
* [knife.test](https://github.com/airstruck/knife/blob/master/readme/test.md) ⭐ 519 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Fixture-free test framework.
* [Luassert](https://github.com/lunarmodules/luassert) ⭐ 248 | 🐛 11 | 🌐 Lua | 📅 2026-08-01 - Extends `assert()` with additional, customizable tests.
...
* [knife.timer](https://github.com/airstruck/knife/blob/master/readme/timer.md) ⭐ 519 | 🐛 2 | 🌐 Lua | 📅 2018-09-17 - Create timers and tweens with ease.
* [Flux](https://github.com/rxi/flux) ⭐ 486 | 🐛 10 | 🌐 Lua | 📅 2020-12-16 - A fast, lightweight tweening library for Lua.
* [tick](https://github.com/rxi/tick) ⭐ 205 | 🐛 0 | 🌐 Lua | 📅 2015-03-11 - Lua module for delaying function calls.
* [NAniTe](https://github.com/MikuAuahDark/NPad93/blob/master/nanite.lua) ⭐ 66 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Timeline-based animation system that supports forward and backward update.
...
* [Slab](https://github.com/flamendless/Slab) ⭐ 394 | 🐛 26 | 🌐 Lua | 📅 2026-07-15 - An immediate mode GUI toolkit for the LÖVE framework.
* [Löve-Nuklear](https://github.com/keharriso/love-nuklear) ⭐ 390 | 🐛 6 | 🌐 C | 📅 2025-02-14 - Lightweight immediate mode GUI for LÖVE games.
* [Love Imgui](https://github.com/slages/love-imgui) ⭐ 351 | 🐛 27 | 🌐 C++ | 📅 2023-12-03 - Imgui module for the LÖVE game engine.
* [LuaJIT-ImGui](https://github.com/sonoro1234/LuaJIT-ImGui) ⭐ 301 | 🐛 9 | 🌐 Lua | 📅 2026-08-13 - LuaJIT bindings for Dear ImGui with a LÖVE module; supports all cimgui widgets using cpp names for easy example copying.
* [GOOi](https://github.com/gustavostuff/gooi) ⭐ 238 | 🐛 5 | 🌐 Lua | 📅 2023-09-06 - Android-oriented GUI library.
* [LoveFrames Fork](https://github.com/linux-man/LoveFrames) ⭐ 156 | 🐛 8 | 🌐 Lua | 📅 2025-10-22 - 11.2 Fork of a GUI library.
* [Helium](https://github.com/qeffects/helium) ⭐ 124 | 🐛 19 | 🌐 Lua | 📅 2025-04-01 - A modern, customizable, high performance retained UI framework.
* [Luis](https://github.com/SiENcE/luis) ⭐ 123 | 🐛 2 | 🌐 Lua | 📅 2026-06-21 - Love UI System - A retained mode UI framework for LÖVE with input processing (mouse, keyboard, touch, gamepad), layer-, grid-, state-, theming-system, UI editor, 16+ widgets (for desktop & mobile).
* [CatUI](https://github.com/wilhantian/catui) ⭐ 116 | 🐛 4 | 🌐 Lua | 📅 2022-06-02 - A very light-weight GUI library for LÖVE.
* [Inky](https://github.com/Keyslam/Inky) ⭐ 85 | 🐛 4 | 🌐 Lua | 📅 2025-12-20 - Any-purpose GUI framework.
* [lovr-ui2d](https://github.com/immortalx74/lovr-ui2d) ⭐ 81 | 🐛 0 | 🌐 Lua | 📅 2025-11-21 - An immediate mode GUI library for LÖVR and LÖVE.
* [NLay](https://github.com/MikuAuahDark/NPad93#nlay) ⭐ 66 | 🐛 1 | 🌐 Lua | 📅 2024-10-05 - Flexible layouting library.
* [Badar 🌕](https://github.com/Nabeel20/Badr) ⭐ 44 | 🐛 0 | 🌐 Lua | 📅 2024-10-04 - Simple **custom UI syntax** for easy components compositions.
* [FlexLöve](https://github.com/mikefreno/FlexLove) ⭐ 39 | 🐛 0 | 🌐 Lua | 📅 2026-08-12 - A fully featured GUI library, supporting flexbox/grid/absolute layouts, both immediate and retained mode, 9patch theming and advanced event support.
* [Patchy](https://github.com/excessive/patchy) ⭐ 38 | 🐛 1 | 🌐 Lua | 📅 2019-03-27 - 9patch library.
* [LOVELi](https://github.com/mtanksl/LOVELi) ⭐ 36 | 🐛 0 | 🌐 Lua | 📅 2026-07-13 - Retained mode layout and GUI library inspired by .NET's MAUI controls with StackLayout, AbsoluteLayout, Grid, Label, Button, Image, CheckBox, RadioButton, Switch, ProgressBar, Slider, TextBox and Border.
...
* [Slicy](https://github.com/wqferr/slicy) ⭐ 18 | 🐛 0 | 🌐 Lua | 📅 2022-05-30 - A newer 9patch/9slice library fixing some issues with Patchy.
...
* [log.lua](https://github.com/rxi/log.lua) ⭐ 360 | 🐛 6 | 🌐 Lua | 📅 2023-08-23 - Library for configurable log output.
* [luasteam](https://github.com/uspgamedev/luasteam) ⭐ 239 | 🐛 3 | 🌐 C++ | 📅 2026-04-09 - Lua bindings for the Steamworks API.
* [cargo](https://github.com/bjornbytes/cargo) ⭐ 184 | 🐛 2 | 🌐 Lua | 📅 2020-02-02 - Asset manager.
...
* [nativefs](https://github.com/EngineerSmith/nativefs) ⭐ 52 | 🐛 1 | 🌐 Lua | 📅 2024-05-02 - Read and write files outside of LÖVE's allowed paths.
...
* [love2d-assets-loader](https://github.com/Yonaba/love2d-assets-loader) ⭐ 41 | 🐛 3 | 🌐 Lua | 📅 2021-05-29 - Assets Loader.
* [smiti18n](https://github.com/Oval-Tutu/smiti18n) ⭐ 40 | 🐛 3 | 🌐 Lua | 📅 2025-12-15 - A very complete internationalization library for Lua with LÖVE support.
* [i18n](https://github.com/excessive/i18n) ⭐ 28 | 🐛 1 | 🌐 Lua | 📅 2015-08-29 - Internationalization library designed to help localize your game.
...
* [love-qrcode](https://github.com/Nawias/love-qrcode) ⭐ 4 | 🐛 1 | 🌐 Lua | 📅 2024-07-17 - QR Code rendering library for LÖVE.
* [ParticleEditor](https://github.com/MusouCrow/ParticleEditor) ⭐ 4 | 🐛 0 | 🌐 Lua | 📅 2018-01-19 - An editor of particle for LÖVE.
* [bar128-love](https://github.com/Nawias/bar128-love) ⭐ 3 | 🐛 0 | 🌐 Lua | 📅 2024-04-30 - Barcode rendering library for LÖVE.
...
* [Tutorial on making an Arkanoid-type game](https://github.com/noooway/love2d_arkanoid_tutorial/wiki) ⭐ 234 | 🐛 5 | 🌐 Lua | 📅 2018-03-01 - A complete tutorial on how to make a breakout clone by nooowaay.
...
* [IntelliJ IDEA](https://www.jetbrains.com/idea/) - Capable and Ergonomic Java IDE.
  * [EmmyLua](https://github.com/EmmyLua/VSCode-EmmyLua) ⭐ 749 | 🐛 39 | 🌐 TypeScript | 📅 2026-08-06 - Lua IDE/Debugger Plugin for VSCode.
...
* [Pulsar](https://pulsar-edit.dev/) - Hackable text editor based on the extinct Atom; Has great support and auto-completion works nicely, but for now lacks error highlighting.
  * [language-lua](https://github.com/FireZenk/language-lua) ⭐ 66 | 🐛 12 | 📅 2019-07-08 - Add syntax highlighting and snippets to lua files.
...
* [Zed](https://zed.dev) - A next-generation code editor designed for high-performance collaboration, written in Rust.
  * [love2d](https://github.com/LuaCATS/love2d) ⭐ 78 | 🐛 4 | 🌐 Lua | 📅 2026-07-20 - LuaCATS typing hints for the lua language server.
...
* [AppImageKit](https://github.com/AppImage/AppImageKit) ⭐ 9,409 | 🐛 237 | 📅 2026-07-26 - Using AppImageKit you can package LÖVE games as AppImages that run on common Linux-based operating systems, such as RHEL, CentOS, Ubuntu, Fedora, Debian and derivatives; one game = one file.
...
* [makelove](https://github.com/pfirsich/makelove) ⭐ 212 | 🐛 27 | 🌐 Python | 📅 2026-06-01 - Advanced multi-platform tool to fuse your game written in Python 3. Supports Windows and Linux with AppImage.
...
* [boon](https://github.com/camchenry/boon) ⭐ 167 | 🐛 5 | 🌐 Rust | 📅 2026-04-02 - Multi-platform, easy to use tool supporting Windows, macOS, Linux.
* [love-build](https://github.com/ellraiser/love-build) ⭐ 99 | 🐛 3 | 🌐 Lua | 📅 2025-05-30 - Downloadable application (made in LÖVE!) that can build games for Windows, macOS, and Linux regardless of your own OS.
...
* [lover](https://github.com/Wolfyxon/lover) ⭐ 46 | 🐛 2 | 🌐 Rust | 📅 2026-07-25 - Bringing the joys of rust's package manager (`Cargo`) to love.
...
* [love-fuser](https://github.com/MikuAuahDark/love-fuser) ⭐ 20 | 🐛 3 | 🌐 Lua | 📅 2023-07-08 - Packages LÖVE Games using GitHub Actions. Supports Windows, Linux, and Android.
...
* [love-deploy](https://github.com/tducasse/love-deploy) ⭐ 15 | 🐛 0 | 🌐 Makefile | 📅 2024-04-07 - Build and deploy games on itch.io (supports windows and web exports).
* [lovesfx](https://github.com/tpimh/lovesfx) ⭐ 13 | 🐛 2 | 🌐 Shell | 📅 2024-07-29 - Packs love games in a single file for windows.
...
* [awesome-lua](https://github.com/LewisJEllis/awesome-lua) ⭐ 4,550 | 🐛 47 | 📅 2024-08-11 - A list like this one, but more general and encompassing all of Lua's uses.
* [awesome-pico8](https://github.com/pico-8/awesome-PICO-8) ⭐ 3,064 | 🐛 0 | 📅 2026-07-28 - A curated list of PICO-8 resources, tutorials, tools and more.
...
Other awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,605 | 🐛 61 | 🌐 Ruby | 📅 2024-06-02 list.
